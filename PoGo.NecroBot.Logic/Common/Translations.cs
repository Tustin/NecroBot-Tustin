...
namespace PoGo.NecroBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.Candies, "Candies: {0:n0}"),
            ...
            new KeyValuePair<TranslationString, string>(Common.TranslationString.LogEntryPKMN, "POKEMON"),
            ...
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusAttempt, "Attempt"),
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusError, "Error"),
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusEscape, "Escape"),
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusFlee, "Flee"),
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusMissed, "Missed"),
            new KeyValuePair<TranslationString, string>(Common.TranslationString.CatchStatusSuccess, "Success"),
