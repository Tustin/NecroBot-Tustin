...
namespace PoGo.NecroBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.EventPokemonCapture, "({0} - {1}) {2} Lvl: {3} ({4:n0}/{5:n0}) CP | IV: {6}% | Chance: {7}% | {8}m dist | {9} ({10} Remaining) | {11}xp | {12}"),
